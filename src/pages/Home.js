...
function Home() {
  const { movie, movieDispatch, toggle, setToggle } = useContext(movieContext);
    ...
    <div className="container">
      ...
      >
        ...
        <div
          className="genre"
          onChange={(e) =>
            movieDispatch({ type: "SET_GENRE", payload: e.target.value })
          }
        >
        ...
        <div className="release-year">
          <select
            ...
            id="release-year"
            onChange={(e) =>
              movieDispatch({ type: "SET_YEAR", payload: e.target.value })
            }
          >
        ...
        <div className="rating">
          <select
            ...
            id="rating"
            onChange={(e) =>
              movieDispatch({ type: "SET_RATING", payload: e.target.value })
            }
          >
        ...
        <div className="new" onClick={() => setToggle(true)}>
      ...
      <div className="forms-home">{toggle && <NewMovie />} </div>
    </div>
  );
}
